...
1. ‚úÖ Menampilkan data dalam ListView dan GridView
2. ‚úÖ Membuat custom list item
3. ‚úÖ Mengimplementasikan navigasi antar halaman
4. ‚úÖ Mengirim dan menerima data antar halaman
5. ‚úÖ Menggunakan named routes

---

## üìÇ RESOURCES

> üí° **File demo tersedia di folder `contoh_kode/pertemuan_3/`**
...
## ‚è±Ô∏è TIMELINE SESI (Total: 150 menit)
...
## üöÄ PART 0: Review & Warm Up (10 menit)

### Quiz Cepat (5 menit)

Pertanyaan untuk mengecek pemahaman:

1. ‚ùì Apa perbedaan StatelessWidget dan StatefulWidget?
2. ‚ùì Widget apa yang dipakai untuk layout horizontal?
3. ‚ùì Apa fungsi `SingleChildScrollView`?
4. ‚ùì Bagaimana cara menggunakan `CircleAvatar` untuk foto profil?
5. ‚ùì Apa fungsi `Theme.of(context)`?

> üí° Jika belum bisa menjawab, review materi Pertemuan 2!

### Konsep Penting (5 menit)

```
üìå KONSEP PENTING PERTEMUAN INI:
...
Analogi Sederhana:
‚Ä¢ ListView = Instagram feed (scroll vertikal satu-satu)
‚Ä¢ GridView = Galeri foto (kotak-kotak)
‚Ä¢ Navigator = Tumpukan buku (push = naruh buku, pop = ambil buku)
```

---

## üìã PART 1: ListView Hands-On (30 menit)

### üí° Konsep Dasar: ListView vs Column
...
‚îÇ              Column                    ListView             ‚îÇ
‚îú‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ‚î§
‚îÇ ‚Ä¢ Tidak bisa scroll otomatis   ‚îÇ ‚Ä¢ Otomatis scrollable      ‚îÇ
‚îÇ ‚Ä¢ Semua item dirender          ‚îÇ ‚Ä¢ Hanya item terlihat      ‚îÇ
‚îÇ ‚Ä¢ Untuk item sedikit (<10)     ‚îÇ ‚Ä¢ Untuk item banyak (10+)  ‚îÇ
‚îÇ ‚Ä¢ Perlu SingleChildScrollView  ‚îÇ ‚Ä¢ Sudah include scroll     ‚îÇ
...
### ‚úèÔ∏è CODING BERSAMA: Contact List App
...
**üìù CATATAN**: Model ini untuk menyimpan data kontak. Properties-nya final karena data tidak berubah setelah dibuat.
...
**Hot Reload** ‚Üí Lihat contact list muncul!

**üí° PENTING**: Perhatikan `itemBuilder` dipanggil untuk setiap item. Ini yang disebut **lazy loading** - hanya render item yang terlihat di layar.
...
**Hot Reload** ‚Üí Sekarang list lebih menarik dengan Card!

### üéØ EKSPERIMEN 1: ListView vs Column
...
3. **Hot Reload** ‚Üí Lihat: Loading lebih lambat karena semua 50 items di-render sekaligus!

4. **Kembalikan ke ListView.builder** ‚Üí Hot Reload ‚Üí Lebih cepat!

**üéØ Lesson**: ListView.builder lebih efisien untuk data banyak!

### üéØ EKSPERIMEN 2: Pull-to-Refresh
...
**Hot Reload** ‚Üí Tarik ke bawah ‚Üí Data di-shuffle!
...
**?? CATATAN**: 
- Layar 400px lebar ? 2 kolom (400 / 150 ò 2.6 ? floor = 2)
